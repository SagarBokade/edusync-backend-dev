 ...
 */
public class AttendanceTypeInUseException extends RuntimeException {
    public AttendanceTypeInUseException(Long typeId) {
        super("Cannot delete Attendance Type ID " + typeId + ". It is currently in use by attendance records.");
    }
}