...
@RestController @RequestMapping("/auth/finance/vendors") @RequiredArgsConstructor
public class VendorController {
    ...
    @PutMapping("/{id}") @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @DeleteMapping("/{id}") @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
