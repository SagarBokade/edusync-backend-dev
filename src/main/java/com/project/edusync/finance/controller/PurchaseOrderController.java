...
@RestController @RequestMapping("/auth/finance/purchase-orders") @RequiredArgsConstructor
public class PurchaseOrderController {
    private final ProcurementServiceImpl procurementService;
    private static final Long SID = 1L;

    @GetMapping @PreAuthorize("hasAnyAuthority('finance:procurement:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    public ResponseEntity<List<PurchaseOrderResponseDTO>> getAll() {
        return ResponseEntity.ok(procurementService.getAllPOs(SID));
    }

    @GetMapping("/{id}") @PreAuthorize("hasAnyAuthority('finance:procurement:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/{id}/submit") @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/{id}/approve") @PreAuthorize("hasAnyAuthority('finance:procurement:approve','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/{id}/reject") @PreAuthorize("hasAnyAuthority('finance:procurement:approve','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/{id}/cancel") @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @GetMapping("/{id}/grns") @PreAuthorize("hasAnyAuthority('finance:procurement:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/grns") @PreAuthorize("hasAnyAuthority('finance:procurement:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @GetMapping("/grns") @PreAuthorize("hasAnyAuthority('finance:procurement:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    public ResponseEntity<List<GRNResponseDTO>> getAllGRNs() {
        return ResponseEntity.ok(procurementService.getAllGRNs(SID));
    }

    @GetMapping("/grns/{id}") @PreAuthorize("hasAnyAuthority('finance:procurement:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
