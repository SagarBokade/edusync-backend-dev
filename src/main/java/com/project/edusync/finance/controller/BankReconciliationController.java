...
/** /auth/finance/bank */
@RestController @RequestMapping("/auth/finance/bank") @RequiredArgsConstructor
public class BankReconciliationController {
    ...
    @GetMapping("/accounts") @PreAuthorize("hasAnyAuthority('finance:bank:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/accounts") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @GetMapping("/accounts/{bankAccountId}/transactions") @PreAuthorize("hasAnyAuthority('finance:bank:read','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/transactions") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/accounts/{bankAccountId}/auto-match") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/transactions/{txId}/manual-match") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/transactions/{txId}/flag-exception") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
    ...
    @PostMapping("/transactions/{txId}/ignore") @PreAuthorize("hasAnyAuthority('finance:bank:write','ROLE_ADMIN','ROLE_FINANCE_ADMIN')")
